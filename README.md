...
This ChiralightSystems fork uses `kyin/worldmodel-checkout` as its working
integration branch. See [Worldmodel integration](worldmodel/README.md) for the
combined optimizer, data/position, cached-KV decoder, validation tools, and
source provenance. The upstream introduction follows below.
